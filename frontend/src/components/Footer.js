...
const Footer = () => {
  ...
  <div className="flex items-center gap-4">
    ...
    <a href="https://www.instagram.com/pccoeacm/" target="_blank" rel="noopener noreferrer">
    ...
    <div className="social-button">
    <a href="https://www.facebook.com/pccoe.acm" target="_blank" rel="noopener noreferrer">
    <button className="relative w-12 h-12 rounded-full group">
    ...
    <div className="social-button">
    <a href="https://www.linkedin.com/company/pccoe-acm-student-chapter" target="_blank" rel="noopener noreferrer">
    <button className="relative w-12 h-12 rounded-full group">
    ...
    <div className="social-button">
    <a href="mailto:pccoeacm@gmail.com" target="_blank" rel="noopener noreferrer">
    <button className="relative w-12 h-12 rounded-full group">
