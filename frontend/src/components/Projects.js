...
const Projects = () => {
  return (
    <div className='w-full min-h-screen relative flex flex-col justify-center items-center'>
      ...
      {/* EvervaultCard Demo */}
      <div className="mt-12 flex gap-6 flex-wrap justify-center space-x-4"> {/* Changed to flex-wrap for responsiveness */}
        <div className="card w-full sm:w-[300px] h-[400px] mb-4"> {/* Responsive width and margin-bottom for spacing */}
