  ...
  return (
    <div className="w-full h-full relative">
      ...
      <div className="absolute top-[10%] left-1/2 -translate-x-1/2 -translate-y-1/2 gap-[1vw] text-[#ffffff7b] z-[2] text-center">
        <h1 className="md:text-[3vw] text-[1.6vh] font-semibold tracking-tighter">
          Join the Open-Source Revolution
        </h1>
        <p className="md:text-[1.3vw] text-[1.15vh]">Open source is changing the world - one pull request at a time.</p>
      </div>
    </div>
  );
};
