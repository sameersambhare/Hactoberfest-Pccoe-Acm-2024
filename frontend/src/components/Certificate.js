  ...
  return (
    <div className="flex w-full justify-center items-center h-[40vh] md:h-[90vh] relative py-[2vw] overflow-hidden">
      ...
      <div className='flex w-full items-center justify-center flex-col gap-5 text-center'>
        {/*------------------ Headings------------------- */}
        <h1 className="text-white font-bold text-[3.8vh]  md:text-[3.5vw] ">Certificate</h1>
        <p className="text-white  text-[1.8vh] md:text-[1.4vw] font-['Space_Mono']">Participate and win these exciting goodies along with participation certificate!!</p>
        {/*-------------- Certificate------------------------------------------------------------------- */}
